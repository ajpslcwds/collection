...
namespace BaoSky::rtps
{
    ...
    public:
        ...
        bool ReadFromCDRMessage(CDRMessage *msg, bool isReadEncapsulation, bool isUseShmTransport,
                                bool isFilterLocator, VendorId_t sourceVendor = VENDORID_TXDDS);
        ...
        GUID mParticipantGuid;
        Duration mLeaseDuration;
        InstanceHandle mInstanceHandle;
        std::chrono::steady_clock::time_point mLastMessageTime;
        std::unordered_map<EntityId, DiscoveredReaderData *> mDiscoveredReaderData;
        std::unordered_map<EntityId, DiscoveredWriterData *> mDiscoveredWriterData;
