...
namespace BaoSky::rtps
{
    ...
    class IEndpoint : public IEntity
    {
    public:
        IEndpoint(const GUID &guid, IHistory *history, IParticipant *participant) : IEntity(guid), mHistory(history), mParticipant(participant) {}
