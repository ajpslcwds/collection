...
namespace BaoSky::rtps
{
    ...
    public:
        ...
        Parameter(rtps::ParameterId_t pid, uint16_t length) : mPid(pid), mLength(length)
        {
        }
        ...
        rtps::ParameterId_t mPid;

        uint16_t mLength;
        typedef std::shared_ptr<Parameter> (*CreateInstanceImpl)();
        static std::map<ParameterId_t, CreateInstanceImpl> mParameters;
    };
}
