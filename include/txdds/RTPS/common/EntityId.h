...
namespace BaoSky::rtps
{
    ...
    {
        return (reader == ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_READER) ? ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_WRITER : (reader == ENTITYID_SEDP_BUILTIN_PUBLICATIONS_READER)  ? ENTITYID_SEDP_BUILTIN_PUBLICATIONS_WRITER
...
namespace std
{
    ...
    {
        std::size_t operator()(
            const BaoSky::rtps::EntityId &k) const
        {
