...
namespace BaoSky::rtps
{
    ...
    public:
         ...
         * @return       {bool} 追加是否成功
         */
        static bool AddProtocolId(CDRMessage &cdrMsg, ProtocolId_t element);
         ...
         * @return       {bool} 追加是否成功
         */
        static bool AddGUID(CDRMessage &cdrMsg, const GUID &element);
         ...
         * @return       {bool} 读取是否成功
         */
        static bool ReadGUID(CDRMessage &cdrMsg, GUID &value);
