...
namespace BaoSky::rtps
{
    ...
    public:
        ...
        virtual bool IsMatchedReader(const GUID &guid) = 0;
        virtual bool ReplyAckNack(const GUID &writerGuid, const GUID &readerGuid, const AckNackMsg &msg) = 0;

        virtual bool ReplyNackFrag(const GUID &writerGuid, const GUID &readerGuid, const NackFragMsg &msg) = 0;
