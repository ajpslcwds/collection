...
namespace BaoSky::rtps
{
    ...
    {
        /**
         * Convert Time to seconds as a double
         */
        ...
        /**
         * Convert Time to seconds as an int64
         */
        ...
        /**
         * Convert Duration to seconds as an int64
         */
        ...
        /**
         * Convert Time to microseconds as a double
         */
        ...
        /**
         * Convert Time to milliseconds as an int64
         */
        ...
        /**
         * Convert Time to milliseconds as a double
         */
        ...
        /**
         * Convert Duration to milliseconds as a double
         */
        ...
        /**
         * Get the absolute difference between two Time in milliseconds as double
         */
        ...
        //! Create a random Time that is millisec + [-randoff,randoff]
        ...
        //! Create a random Time that is microsec + [-randoff,randoff]
        ...
        //! Create a random Time that is sec + [-randoff,randoff]
