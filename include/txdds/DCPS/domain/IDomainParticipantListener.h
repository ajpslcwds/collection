...
namespace BaoSky::dds
{
    ...
    class IDomainParticipantListener : public IPublisherListener, public ITopicListener, public ISubscriberListener
    {
    public:
        ...
        virtual void OnParticipantDiscovery(
            ...
            BaoSky::rtps::ParticipantDiscoveryInfo &&info)
        {
            (void)participant;
            (void)info;
        }
        ...
        virtual void OnReaderDiscovery(
            IDomainParticipant *participant,
            BaoSky::rtps::ReaderDiscoveryInfo &&info)
        {
            (void)participant;
            (void)info;
        }
        ...
        virtual void OnWriterDiscovery(
            IDomainParticipant *participant,
            BaoSky::rtps::WriterDiscoveryInfo &&info)
        {
            (void)participant;
            (void)info;
        }

        virtual void OnTypeDiscovery(
            IDomainParticipant *participant,
            const std::string &topicName,
            const BaoSky::dds::TypeIdentifier *identifier,
            const BaoSky::dds::TypeObject *object,
            std::shared_ptr<BaoSky::dds::DynamicType> dynType)
        {
            (void)participant;
            (void)topicName;
            (void)identifier;
