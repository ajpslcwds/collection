...
namespace BaoSky::dds
{
    ...
    {
    public:
        LocatorParameter(BaoSky::rtps::ParameterId_t pid, rtps::Locator locator) : BaoSky::rtps::Parameter(pid, 24), mLocator(locator)
        {
        }
    ...
    public:
        ...
        EndpointGuidParameter() : ParticipantGuidParameter(GUID())
        {
            mPid = rtps::PID_ENDPOINT_GUID;
        }
        bool ReadFromCDRMsg(rtps::CDRMessage &cdrMsg, uint16_t paraLength) override;
