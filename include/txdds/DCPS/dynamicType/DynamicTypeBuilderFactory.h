...
namespace BaoSky::dds
{
    ...
    public:
        ...
        DynamicTypeBuilder *CreateCustomBuilder(
    ...
    private:
        ...
        ~DynamicTypeBuilderFactory();
        std::shared_ptr<DynamicType> mBoolDynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_BOOLEAN))};
        std::shared_ptr<DynamicType> mByteDynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_BYTE))};
        std::shared_ptr<DynamicType> mInt8DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_INT8))};
        std::shared_ptr<DynamicType> mUint8DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_UINT8))};
        std::shared_ptr<DynamicType> mInt16DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_INT16))};
        std::shared_ptr<DynamicType> mUint16DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_UINT16))};
        std::shared_ptr<DynamicType> mInt32DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_INT32))};
        std::shared_ptr<DynamicType> mUint32DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_UINT32))};
        std::shared_ptr<DynamicType> mInt64DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_INT64))};
        std::shared_ptr<DynamicType> mUint64DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_UINT64))};
        std::shared_ptr<DynamicType> mFloat32DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_FLOAT32))};
        std::shared_ptr<DynamicType> mFloat64DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_FLOAT64))};
        std::shared_ptr<DynamicType> mFloat128DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_FLOAT128))};
        std::shared_ptr<DynamicType> mChar8DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_CHAR8))};
        std::shared_ptr<DynamicType> mChar16DynamicType{std::make_shared<DynamicType>(TypeDescriptor(TK_CHAR16))};
