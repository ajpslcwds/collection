...
{
    class TypeIdentifierParameter : public BaoSky::rtps::Parameter, public QosPolicy
    {
    public:
        TypeIdentifier mTypeIdentifier;
        TypeIdentifierParameter()
            : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_TYPE_IDV1, 0), QosPolicy(false), mTypeIdentifier()
        {
        }
    ...
    class TypeObjectParameter : public BaoSky::rtps::Parameter, public QosPolicy
    {
    public:
        TypeObject mTypeobject;
        TypeObjectParameter()
            : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_TYPE_OBJECTV1, 0), QosPolicy(false), mTypeobject()
        {
        }
        bool AddToCDRMsg(rtps::CDRMessage &cdrMsg) override;
