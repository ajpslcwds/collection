...
#define PARAMETER_KIND_LENGTH 4
    ...
    public:
        HistoryQosPolicy()
            : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_HISTORY, PARAMETER_KIND_LENGTH + 4),
              QosPolicy(true),
    ...
    public:
        ReliabilityQosPolicy()
            : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_RELIABILITY, PARAMETER_KIND_LENGTH + PARAMETER_TIME_LENGTH),
              QosPolicy(true),
    ...
    {
    public:
        DurabilityQosPolicy() : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_DURABILITY, PARAMETER_KIND_LENGTH), QosPolicy(true), mKind(VOLATILE_DURABILITY_QOS)
        {
        }
    ...
    {
    public:
        PartitionQosPolicy() : BaoSky::rtps::Parameter(BaoSky::rtps::ParameterId_t::PID_PARTITION, 0), QosPolicy(true)
        {
        }
