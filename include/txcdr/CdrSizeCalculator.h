...
namespace BaoSky::Cdr
{
    ...
    public:
        ...
        template <class _T>
        std::size_t CalculateMemberSerializedSize(const uint32_t &id, const _T &data, std::size_t &current_alignment)
        {
            std::size_t initial_alignment{current_alignment};
            ...
            std::size_t prev_size{current_alignment - initial_alignment};
            std::size_t extra_size{0};

            std::size_t calculated_size{CalculateSerializedSize(data, current_alignment)};
